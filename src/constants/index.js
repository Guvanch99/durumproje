...
export const ROUTER_TWO_FACTOR_AUTH='/two-factor-auth'
export const DARK_GREEN_COLOR = '#1d3c45'
...
/* eslint-disable */
export const EMAIL_VALIDATION = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w\w+)+$/
...
export const NUMBER_CHECKER=/^[0-9\b]+$/;